...
public class DrinksActivity extends AppCompatActivity {
    ...
    private void viewDetails() {
       lvDrink.setOnItemClickListener(new AdapterView.OnItemClickListener() {
           ...
           public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
               Dialog dialog = new Dialog(DrinksActivity.this);
               ...
               Id = arrayListDrink.get(i).getId();
               idCategory = arrayListDrink.get(i).getIdCategory();
               Name = arrayListDrink.get(i).getpName();
               Price = arrayListDrink.get(i).getPrice();
               Image = arrayListDrink.get(i).getImage();
               Description = arrayListDrink.get(i).getDescription();
               ...
               btAddCard.setOnClickListener(new View.OnClickListener() {
                   ...
                   public void onClick(View view) {
                       ...
                       Check.ShowToast(DrinksActivity.this," Sản phẩm đã được thêm vào giỏ hàng");
                   }
               });
               dialog.show();
           }
   ...
   /* private void DialogDetail(){
    ...
    private void getDataDrink() {
        ...
        String linkGetDrink = "http://foodsale.000webhostapp.com/localhost/getProduct.php";
        StringRequest stringRequest = new StringRequest(Request.Method.POST, linkGetDrink, new Response.Listener<String>() {
            @Override
                ...
                if(response != null){
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++){
                            ...
                            arrayListDrink.add(new Product(Id,Name,Price,Image,Description,idCategory));
    ...
    private void actionToolBar() {
        toolBarDrink.setNavigationIcon(R.drawable.goback);
    ...
    private void anhXa() {
        ...
        drinkAdapter = new DrinkAdapter(getApplicationContext(),arrayListDrink);
